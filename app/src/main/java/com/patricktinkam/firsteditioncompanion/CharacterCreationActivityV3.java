...
/** v0.9.6: reusable source-detail affordances for rules warnings/checks. */
public class CharacterCreationActivityV3 extends CharacterCreationActivityV2 {
  @Override void buildShell(){
    ...
    TextView title=t("CREATE CHARACTER  •  v0.9.6",19,GOLD,true);title.setGravity(Gravity.CENTER);root.addView(title,new LinearLayout.LayoutParams(-1,dp(52)));
