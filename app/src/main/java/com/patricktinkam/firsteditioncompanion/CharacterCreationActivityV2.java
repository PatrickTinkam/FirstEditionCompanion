...
/** v0.9.2 presentation layer for the guided creator. */
public class CharacterCreationActivityV2 extends CharacterCreationActivity {
  @Override void buildShell(){
    ...
    TextView title=t("CREATE CHARACTER  •  v0.9.2",19,GOLD,true);title.setGravity(Gravity.CENTER);root.addView(title,new LinearLayout.LayoutParams(-1,dp(52)));
